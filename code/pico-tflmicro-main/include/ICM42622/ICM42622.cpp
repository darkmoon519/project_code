...
{
  uint8_t Ascale = AFS_4G, Gscale = GFS_2000DPS, AODR = AODR_100Hz, GODR = GODR_100Hz; // default setting -pp 
  // uint8_t Ascale = AFS_2G, Gscale = GFS_2000DPS, AODR = AODR_100Hz, GODR = GODR_100Hz;    // changed by pp
  uint8_t DeviceID=0;
